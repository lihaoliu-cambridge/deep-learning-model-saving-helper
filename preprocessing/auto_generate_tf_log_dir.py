...
def _synchronize_and_generate_subdir(tensorboard_dir, model_dir, note_dir, pattern):
    """
...
def genarate_tf_log_dir(args_config_file_path, tensorboard_dir, model_dir, note_dir, self_increasing_mode, pattern):
