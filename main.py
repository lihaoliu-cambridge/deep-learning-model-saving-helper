...
from process import load_config, process
...
def set_logging(error_log_config_file_path, error_log_folder_path, error_log_level):
    ...
    log_config = load_config(error_log_config_file_path)
...
def main():
    ...
    group_call = parser.add_argument_group("Initialization parameters", "Parameters are used for initialize program.")
    group_call.add_argument("--args_config_file_path", default="./conf/args.yaml",
